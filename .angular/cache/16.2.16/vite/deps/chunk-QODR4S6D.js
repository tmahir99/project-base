...
function withNoDomReuse() {
  return hydrationFeature(
    0
    /* HydrationFeatureKind.NoDomReuseFeature */
  );
}
...
function provideClientHydration(...features) {
  ...
  return makeEnvironmentProviders([typeof ngDevMode !== "undefined" && ngDevMode ? provideZoneJsCompatibilityDetector() : [], featuresKind.has(
    0
    /* HydrationFeatureKind.NoDomReuseFeature */
  ) ? [] : withDomHydration(), featuresKind.has(
    1
    /* HydrationFeatureKind.NoHttpTransferCache */
  ) ? [] : withHttpTransferCache(), providers]);
}
...
@angular/platform-browser/fesm2022/platform-browser.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-QODR4S6D.js.map
