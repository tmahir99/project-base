...
var _EffectManager = class _EffectManager {
  constructor() {
    ...
    for (let i = 0; i < resolutionPath.length; i++) {
      ...
      if (instance2 !== null) {
        if (dep.flags.host) {
          ...
          const lookupFromFirstInjector = firstInjector.get(dep.token, null, __spreadProps(__spreadValues({}, dep.flags), { optional: true }));
...
function getEnvironmentInjectorProviders(injector) {
  ...
  return providerRecords.map((providerRecord) => {
    ...
    return __spreadProps(__spreadValues({}, providerRecord), { importPath });
  });
}
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-JIBT2MMA.js.map
