...
// node_modules/@tinkoff/ng-dompurify/fesm2015/tinkoff-ng-dompurify.js
...
var NgDompurifySanitizer = class {
  constructor(config, sanitizeStyle, {
    defaultView
  }, hooks) {
    this.config = config;
    this.sanitizeStyle = sanitizeStyle;
    this.domPurify = createDOMPurify2(defaultView);
    hooks.forEach(({
      name,
      hook
    }) => {
...
NgDompurifySanitizer.ɵfac = function NgDompurifySanitizer_Factory(t) {
  return new (t || NgDompurifySanitizer)(ɵɵinject(DOMPURIFY_CONFIG), ɵɵinject(SANITIZE_STYLE), ɵɵinject(DOCUMENT), ɵɵinject(DOMPURIFY_HOOKS));
};
NgDompurifySanitizer.ɵprov = ɵɵdefineInjectable({
...
NgDompurifyPipe.ɵfac = function NgDompurifyPipe_Factory(t) {
  return new (t || NgDompurifyPipe)(ɵɵdirectiveInject(NgDompurifySanitizer, 16), ɵɵdirectiveInject(DomSanitizer, 16));
};
NgDompurifyPipe.ɵpipe = ɵɵdefinePipe({
  name: "dompurify",
...
var NgDompurifyModule = class {
};
NgDompurifyModule.ɵfac = function NgDompurifyModule_Factory(t) {
  return new (t || NgDompurifyModule)();
};
NgDompurifyModule.ɵmod = ɵɵdefineNgModule({
  type: NgDompurifyModule,
  declarations: [NgDompurifyPipe],
  exports: [NgDompurifyPipe]
});
NgDompurifyModule.ɵinj = ɵɵdefineInjector({});
(function() {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NgDompurifyModule, [{
    type: NgModule,
    args: [{
      declarations: [NgDompurifyPipe],
      exports: [NgDompurifyPipe]
